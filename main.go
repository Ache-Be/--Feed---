...
func runAPI(ctx context.Context) {
	...
	mux.HandleFunc("/video/comment", handlers.CommentVideo)
	mux.HandleFunc("/video/comments", handlers.ListComments)
	mux.HandleFunc("/video/comment/delete", handlers.DeleteComment)
	mux.HandleFunc("/video/favorite", handlers.FavoriteVideo)
	mux.HandleFunc("/video/unfavorite", handlers.UnfavoriteVideo)
	mux.HandleFunc("/video/favorites", handlers.ListFavorites)
	mux.HandleFunc("/video/likes", handlers.ListLikes)
